		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Scrap Movements",
									"targetURL": "#zdomscrapmovements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zdomscrapmovements-display": {
								"semanticObject": "zdomscrapmovements",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zdomscrapmovements",
									"url": sap.ui.require.toUrl("zdomscrapmovements")
								}
							}
						}
					}
